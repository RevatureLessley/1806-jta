...
/**
 * Servlet that handles incoming Web traffic using the Front Controller Design Pattern
 */
...
//        if (!url.equals("/GetAllEmployees.Servlet") && !url.equals("/Employment.Servlet") &&  req.getSession(false) == null){ //TODO: Hardcode
