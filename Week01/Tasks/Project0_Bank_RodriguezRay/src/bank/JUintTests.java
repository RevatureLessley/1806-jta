...
public class JUintTests {
	...
	public void setUp() throws Exception {
		user = new UserAccount("user", "Test", "Tester", "test", "1234", 2000);
		user2 = new UserAccount("user", "Test", "Tester", "test", "1234", 2000);
		user3 = new UserAccount("user", "Test", "Tester", "test", "1234", 2000);
	}
