...
create table project_1_reimbursement_form (
    ...
    benco_comments varchar2(3000),
    supervisor_decision varchar2(15),
    supervisor_decision_date date,
    supervisor_comments varchar2(3000),
    department_head_decision varchar2(15),
    department_head_decision_date date,
    department_head_comments varchar(3000),
