...
public class EmployeeDaoImplTest {
    ...
    public static void beforeClass(){
        employee = new EmployeeBean(ID,"Test","Dude", "pass",1112223333L,"tdude@email.com",
                156.07,0,SID,DHID,BCID);
        supervisor = new EmployeeBean(SID, "Super", "Visor", "supdup", 2223334444L, "svisor@email.com",
                0,950.28,SID,DHID,BCID);
        deptHead = new EmployeeBean(DHID, "Dept", "Head", "goalll", 3334445555L, "dhead@email.com",
                0,0,DHID,DHID, BCID);
        benCo = new EmployeeBean(BCID, "Ben", "Co", "superStrongPassword234439293$49fadaodasjaf!!#", 4445556666L, "bCo@email.com",
                0,0,BCID, BCID, BCID);
    ...
    public void retrieveEmployeeById() {
        ...
        assertEquals(employee.getPassword(), bean.getPassword());
        ...
        assertEquals(supervisor.getPassword(), bean.getPassword());
        ...
        assertEquals(deptHead.getPassword(), bean.getPassword());
        ...
        assertEquals(benCo.getPassword(), bean.getPassword());
    ...
    public void insertEmployee() {
        ...
        EmployeeBean bean = new EmployeeBean(id, "test", "name", "password", 9876543210L, "test@email.com",
        ...
        assertEquals(bean.getPassword(), dao.retrieveEmployeeById(id).getPassword());
