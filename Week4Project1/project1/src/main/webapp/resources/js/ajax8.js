...
function getLevelTwoReimbursements()
{
	...
	let reimTable = document.getElementById("employeependingalllevelreimbursementtable");
	let head = document.getElementById("pendingalllevelreimbursementhead");
	let url = "../GetAllLevelPendingReimbursements";
	...
	xhr.onreadystatechange = function()
	{
		if(xhr.readyState==4)
		{
			...
			for(index in data)
			{
				...
				approveForm.setAttribute('action',"../BenCoApproveServlet");
				...
				declineForm.setAttribute('action',"../BenCoDeclineServlet");
