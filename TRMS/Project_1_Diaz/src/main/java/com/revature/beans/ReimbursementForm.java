...
public class ReimbursementForm {
	...
	public ReimbursementForm(Integer rfId, Integer empId, String formStatus, String eventType, String eventLocation,
			String eventDescribtion, Integer eventCost, Date formsDate, Date startDate, String gradeFormat,
			String gradeCutOff, String workTimeMissed) {
		super();
		this.rfId = rfId;
		this.empId = empId;
	...
	public ReimbursementForm(Integer rfId, String formStatus2, String eventType) {
		super();
		this.rfId = rfId;
		this.formStatus2 = formStatus2;
		this.eventType = eventType;
	...
	public ReimbursementForm(Integer rfId, String formStatus, String eventType, String eventLocation) {
		super();
		this.rfId = rfId;
		this.formStatus = formStatus;
		this.eventType = eventType;
