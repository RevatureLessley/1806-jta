...
public class LoginServlet2 extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		String userName = request.getParameter("Employee_UserName2");
		String password = request.getParameter("Employee_Password2");
		...
		if(EmployeeService.employeeLogin( userName, password)){
			...
			session.setAttribute("Employee_UserName2", userName);
			System.out.println("LOGIN STARTED: " + (String)session.getAttribute("Employee_UserName2"));
