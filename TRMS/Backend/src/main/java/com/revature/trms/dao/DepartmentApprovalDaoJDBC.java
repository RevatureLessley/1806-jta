...
public class DepartmentApprovalDaoJDBC implements DepartmentApprovalDao {
  ...
  public void insertApprovalStatus(Integer id, Integer requestId, Integer approved) {
    ...
    String sql = "INSERT INTO DEPTHEAD_APPROVAL VALUES (?,?,?,?)";
  ...
  public Integer selectApprovalByRequestId(Integer requestId) {
    ...
    ResultSet rs = null;
    String sql = "SELECT COUNT(*) FROM DeptHead_Approval WHERE request_id = ?";
    try(Connection conn = ConnectionUtil.getConnection()) {
