#Feature is the first keyword of a feature file that simply designates ita s such.
Feature: Mercury Tours Login
	...
	#Scenario Outline must be used in lieu of 
...
#		|tropicana|tropicana|
#		|goodbye	|hello		|
		#Example tables provide us the opprotunity for data driven frameworks.
