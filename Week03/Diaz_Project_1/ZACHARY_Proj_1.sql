...
---------------------------------------------------------------------------------------
/
CREATE OR REPLACE PROCEDURE insertIntoAprovel(AprovelOne IN VARCHAR2,
...
IS
BEGIN
    INSERT INTO Aprovel (Aprovel_One, Aprovel_Two, Aprovel_Three,Total_Reimburstment,Pending_Reimburstments,Awarded_Reimburstments,Available_Reimburstment)
    VALUES(AprovelOne, AprovelTwo, AprovelThree,TotalReimburstment,PendingReimburstments,AwardedReimburstments,AvailableReimburstment);
    COMMIT;
END;
/
CALL insertIntoAprovel('No','No','No',1000,0,0,1000);
Select * from Aprovel;
---------------------------------------------------------------------------------------
/
...
IS
BEGIN
    INSERT INTO ReimbursementForm (Start_Date, Forms_Date, Grade_Cut_Off,Event_ID)
    VALUES(StartDate, FormsDate, GradeCutOff,EventID);
    COMMIT;
END;
/
CALL insertReimbursementForm(TO_DATE('2018-10-01','YYYY-MM-DD'),TO_DATE('2018-07-07','YYYY-MM-DD'),'B',1);
...
END;
/
CALL insertEmployee (100,1,'Zachary','Diaz','Diaz123','972-555-5533','diaz_zachary@test.com');
