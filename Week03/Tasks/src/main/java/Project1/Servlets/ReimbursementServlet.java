...
//	    	String grading = request.getParameter("grading");
			...
			String timeMissed = request.getParameter("timeMissed") + " 0:0:0.0";
			
			Reimbursement reimbursement = 
					ReimbursementService.submitReimbursement(username, type, 
															 cost, eventTime, 
															 location, 
															 timeMissed, 
															 cutoff, 
			...
			employee.insertReimbursement(reimbursement.getId(), reimbursement);
