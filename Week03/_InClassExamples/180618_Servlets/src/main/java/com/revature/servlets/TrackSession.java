...
public class TrackSession extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//If parameter is false, do NOT create a session if one does not exists
		/*
		 *	If a user gets a session for hte first time, you are given a brand new
		 *session. If a session already exists, you are given the already created
		 *session. 
		 */
